...
- **[probably-need | concept]** **Harness Resume** — on re-invocation after an interrupted run, a bot checks whether the prior run's artifacts are still fresh; if fresh, resumes from the next incomplete stage; if stale (or ambiguous), discards and starts over.
  Surfaced: conversation, 2026-06-10. See: #29.
